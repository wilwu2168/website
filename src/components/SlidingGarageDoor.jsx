  ...
  return (
    <group position={[0, 0, 8]}>
      <group position={[-1, 0, 0]}>
        <group ref={ref}>
          <RoundedBox args={[2, 4, 0.1]} radius={0.02} smoothness={1} position={[1, 2, 0.05]} castShadow receiveShadow>
            <meshStandardMaterial color="#8b4513" roughness={0.5} metalness={0.05} />
          </RoundedBox>
          <mesh position={[1.7, 2, 0.11]}>
...
export const SlidingGarageDoor = forwardRef((props, ref) => {
  return (
    <group position={[0, 0, 8]}>
      <group ref={ref}>
        <RoundedBox args={[20, 8, 0.2]} radius={0.03} smoothness={1} position={[0, 4, 0]} castShadow receiveShadow>
        ...
        <RoundedBox args={[2, 0.2, 0.1]} radius={0.03} smoothness={1} position={[0, 0.2, 0.15]}>
